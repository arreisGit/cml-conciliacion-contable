...
--( 3, 'CXC', 'Factura Anticipo CFD', 'CXC',  'Factura Anticipo CFD', -1, 0, 0, NULL,  NULL),
  ...
  ( 4, 'CXC', 'Aplicacion Saldo',     'CXC',  'Aplicacion Saldo',     -1, 1, 0, NULL,  NULL),
  ( 4, 'CXC', 'Cobro' ,               'CXC',  'Cobro',                -1, 1, 0, NULL,  NULL),
  ( 4, 'CXC', 'Cobro Anticipo',       'CXC',  'Cobro Anticipo',       -1, 1, 0, NULL,  NULL),
  ( 4, 'CXC', 'Conversion Cargo',     'CXC',  'Conversion Cargo',     -1, 1, 0, NULL,  NULL),
  ( 4, 'CXC', 'Conversion Credito',   'CXC',  'Conversion Credito',    1, 1, 0, NULL,  NULL),
