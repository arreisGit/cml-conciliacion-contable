...
IF EXISTS (SELECT * 
		   FROM SYSOBJECTS 
		   WHERE ID = OBJECT_ID('dbo.CUP_SPQ_ConciliacionCont_SaldosEsperados_AuxCxp') AND 
				 TYPE = 'P')
BEGIN
  DROP PROCEDURE dbo.CUP_SPQ_ConciliacionCont_SaldosEsperados_AuxCxp 
END	
...
GO
 ...
 /*=============================================
   ...
   que se usaran para la conciliacion Cotable de Proveedores
 
   Example: EXEC CUP_SPQ_ConciliacionCont_SaldosEsperados_AuxCxp 2016, 10
 ============================================= */


CREATE PROCEDURE dbo.CUP_SPQ_ConciliacionCont_SaldosEsperados_AuxCxp
  @Ejercicio INT,
  @Periodo   INT
AS BEGIN 
