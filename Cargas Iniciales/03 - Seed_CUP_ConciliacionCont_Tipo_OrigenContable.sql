...
VALUES
  ...
  /* IVA Por Acreeditar */
  ( 2, 'CXP', 'Ajuste',               'CXP',  'Ajuste',                1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Ajuste Redondeo',      'CXP',  'Ajuste Redondeo',       1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Ajuste Saldo',         'CXP',  'Ajuste Saldo',          1, 0, 0, NULL,  NULL),
  ...
  ( 2, 'CXP', 'Cargo Proveedor IVA',  'CXP',  'Cargo Proveedor IVA',   1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Conversion Cargo',     'CXP',  'Conversion Cargo',     -1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Conversion Credito',   'CXP',  'Conversion Credito',    1, 0, 0, NULL,  NULL),
  ...
  ( 2, 'CXP', 'Devolucion Retencion', 'CXP',  'Devolucion Retencion', -1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Endoso a Favor',       'CXP',  'Endoso a Favor',        1, 1, 0, NULL,  NULL),
  ( 2, 'CXP', 'Entrada Compra',       'COMS', 'Entrada Compra',        1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Entrada con Gastos',   'COMS', 'Entrada con Gastos',    1, 0, 0, NULL,  NULL),
  ...
  ( 2, 'CXP', 'Prestamo',             'CXP',  'Prestamo',              1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Retencion',            'CXP',  'Retencion',             1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Reevaluacion',         'CXP',  'Reevaluacion',          1, 0, 0, NULL,  NULL),
  ( 2, 'CXP', 'Reevaluacion Credito', 'CXP',  'Reevaluacion Credito',  1, 0, 0, NULL,  NULL)
